...
export const cases = [
  ...
  },
  {
    ...
    maxCredibility: 10,
    failureText:
      "杜助教把方程编号圈了起来：“三阶不会因为你偷懒就自动降成二阶，你输掉这一案，不是算不出指数，而是忘了重根会带来整串独立解，少一维就少整个解空间。唉唉，你回去还要多做做《大邮数学集》才行呐”。",
    initialEvidence: [
      "ev-nth-order-dimension",
      "ev-repeated-root-theorem",
      "ev-case6-charpoly",
    ...
    events: [
      {
        ...
        lines: [
          system(
            "旁白",
            "一本《大邮数学集》的页面在白板上静静展开，答疑研讨间里只剩最后一行方程和最后一点耐心。杜助教写板书的速度像在宣告：常系数线性方程这种事，熟练就该像呼吸一样自然。",
          ),
          npc(
            "开场",
