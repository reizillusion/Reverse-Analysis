...
export const cases = [
  {
    ...
    intro:
      "晚自习快到熄灯时间，宿舍楼公共自习室里的白板却被魏同学占得满满当当。他突然用马克笔在板面上敲了一下，宣布今晚要当场拆掉一个“每学期都会在作业群复活一次的错误命题”。白板中央只写了一个熟得发烫的函数：|x|。有人低声说，完了，魏同学今晚显然没打算只刷题，他是来给概念清库存的。",
    player: {
      name: "王若臣",
      role: "计算机系本科生",
      glyph: "王",
    ...
    events: [
      {
        ...
        lines: [
          ...
          npc(
            "开场",
            "今天我们处理一个常年潜伏在作业纸里的病句。|x| 在 0 左右导数不同，所以它在 0 当然不连续。谁要是还分不清这两个概念，下次作业的红笔批注会替他分清。",
          ),
          cameo(
            "A同学",
            "小声",
    ...
    events: [
      {
        ...
        lines: [
          ...
          player(
            "心声",
            "他把原点周围那块空白讲得像背景色。可有时候，一个洞就足够让整个结论绕一大圈回来。",
          ),
        ],
      },
      {
